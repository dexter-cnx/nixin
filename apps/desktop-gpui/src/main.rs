                                    ...
                                    .child(
                                        div()
                                            ...
                                            .child(
                                                div()
                                                    .text_lg()
                                                    .child(format!("{section} shell")),
                                            )
                                            .child(
                                                div()
                                                    .text_sm()
                                                    .text_color(rgb(0x8d929c))
                                                    .child("Production GPUI presentation only. Domain/catalog/import semantics remain behind the frontend-neutral Rust API."),
                                            )
                                            .child(
                                                div()
                                                    .text_sm()
