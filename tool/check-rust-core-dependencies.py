#!/usr/bin/env python3
"""Fail when protected Rust core crates depend on frontend/framework crates."""
...
MANIFEST = ROOT / "crates" / "dextryx-core" / "Cargo.toml"
PROTECTED_PACKAGES = {"dextryx-core"}
FORBIDDEN_NAMES = {
    "gpui",
    "gpui_platform",
    "flutter_rust_bridge",
...
def main() -> int:
    ...
    print("Rust core dependency boundary: PASS")
    return 0
